...
TOKEN = '7687282251:AAFgNYWEgd-rvGLNzVVrgYhK-IuvQaDP37Q'  # Replace with your actual bot token
...
def bgmi_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./soul {target_ip} {target_port} {default_duration} 200")
